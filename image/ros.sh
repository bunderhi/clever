...
echo -e "\033[0;31m\033[1m$(date) | #7 Preparing other ROS-packages to kinetic-custom_ros.rosinstall\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #8 Installing dependencies apps with rosdep\033[0m\033[0m"

# Resolving Dependencies with rosdep
cd /home/pi/ros_catkin_ws \
  && rosdep install -y --from-paths src --ignore-src --rosdistro kinetic -r --os=debian:stretch

echo -e "\033[0;31m\033[1m$(date) | #9 Refactoring usb_cam in SRC\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #10 Installing GeographicLib datasets\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #11 Building packages on 1 thread\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #13 Creating catkin_ws\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #14 Installing CLEVER-BUNDLE\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #15 Adding mjpg-streamer at /home/pi\033[0m\033[0m"
...
echo -e "\033[0;31m\033[1m$(date) | #16 Adding ENV vars\033[0m\033[0m"
